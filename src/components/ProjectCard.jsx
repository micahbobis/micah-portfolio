...
const ProjectCard = React.memo(({ title, desc, tech, github, live }) => (
  <div className="bg-beige rounded-xl shadow-md p-5 hover:shadow-lg hover:scale-[1.03] transition-transform duration-300 border border-graySoft">
    <div className="h-32 mb-4 flex items-center justify-center rounded-xl overflow-hidden bg-gray-200 text-gray-500">
  {img ? (
